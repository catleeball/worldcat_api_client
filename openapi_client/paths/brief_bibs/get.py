...
class FacetsSchema(
    ...
    def __getitem__(self, i: int) -> MetaOapg.items:
        return super().__getitem__(i)
GroupRelatedEditionsSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'groupRelatedEditions': typing.Union[GroupRelatedEditionsSchema, bool, ],
...
request_query_group_related_editions = api_client.QueryParameter(
    name="groupRelatedEditions",
    style=api_client.ParameterStyle.FORM,
    schema=GroupRelatedEditionsSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _search_brief_bibs_oapg(
        ...
        for parameter in (
            ...
            request_query_group_related_editions,
...
class SearchBriefBibs(BaseApi):
    ...
    def search_brief_bibs(
        ...
        return self._search_brief_bibs_oapg(
