...
HeldInStateSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'heldInState': typing.Union[HeldInStateSchema, str, ],
...
request_query_held_in_state = api_client.QueryParameter(
    name="heldInState",
    style=api_client.ParameterStyle.FORM,
    schema=HeldInStateSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_bib_retained_holdings_oapg(
        self,
...
class FindBibRetainedHoldings(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def find_bib_retained_holdings(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def find_bib_retained_holdings(
        ...
        return self._find_bib_retained_holdings_oapg(
